...
**Option B — Bearer token.** Configure a long-lived token in your local MCP client only (never paste it into chat). Mint tokens at https://managed.payments.ai/developer-tools.
